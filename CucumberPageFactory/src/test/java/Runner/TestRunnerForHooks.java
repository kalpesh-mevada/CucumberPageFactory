...
@Suite
@SelectClasspathResource("HooksDemo/HooksDemo.feature")
...
/*
 * @ConfigurationParameter( key = "cucumber.execution.parallel.enabled", value =
 * "true" )
 * 
 ...
 * "cucumber.execution.parallel.config.fixed.parallelism", value = "2"
 * 
 * )
 */
